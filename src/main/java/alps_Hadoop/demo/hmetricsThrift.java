...
public class hmetricsThrift {

  public interface Iface {

    public void put(HMetrics newHMetrics) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void put(HMetrics newHMetrics, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public void put(HMetrics newHMetrics) throws org.apache.thrift.TException
    {
      send_put(newHMetrics);
      recv_put();
    }

    public void send_put(HMetrics newHMetrics) throws org.apache.thrift.TException
    {
      put_args args = new put_args();
      args.setNewHMetrics(newHMetrics);
      sendBase("put", args);
    }
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void put(HMetrics newHMetrics, org.apache.thrift.async.AsyncMethodCallback resultHandler) throws org.apache.thrift.TException {
      checkReady();
      put_call method_call = new put_call(newHMetrics, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class put_call extends org.apache.thrift.async.TAsyncMethodCall {
      private HMetrics newHMetrics;
      public put_call(HMetrics newHMetrics, org.apache.thrift.async.AsyncMethodCallback resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
        super(client, protocolFactory, transport, resultHandler, false);
        this.newHMetrics = newHMetrics;
      }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class put<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, put_args, Void> {
      ...
      public void start(I iface, put_args args, org.apache.thrift.async.AsyncMethodCallback<Void> resultHandler) throws TException {
        iface.put(args.newHMetrics,resultHandler);
      }
    }
  ...
  public static class put_args implements org.apache.thrift.TBase<put_args, put_args._Fields>, java.io.Serializable, Cloneable, Comparable<put_args>   {
    ...
    private static final org.apache.thrift.protocol.TField NEW_HMETRICS_FIELD_DESC = new org.apache.thrift.protocol.TField("newHMetrics", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public HMetrics newHMetrics; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      NEW_HMETRICS((short)1, "newHMetrics");
    ...
    static {
      ...
      tmpMap.put(_Fields.NEW_HMETRICS, new org.apache.thrift.meta_data.FieldMetaData("newHMetrics", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, HMetrics.class)));
    ...
    public put_args(put_args other) {
      if (other.isSetNewHMetrics()) {
        this.newHMetrics = new HMetrics(other.newHMetrics);
      }
    }
    ...
    @Override
    public void clear() {
      this.newHMetrics = null;
    }

    public HMetrics getNewHMetrics() {
      return this.newHMetrics;
    }

    public put_args setNewHMetrics(HMetrics newHMetrics) {
      this.newHMetrics = newHMetrics;
      return this;
    }

    public void unsetNewHMetrics() {
      this.newHMetrics = null;
    }

    /** Returns true if field newHMetrics is set (has been assigned a value) and false otherwise */
    public boolean isSetNewHMetrics() {
      return this.newHMetrics != null;
    }

    public void setNewHMetricsIsSet(boolean value) {
      if (!value) {
        this.newHMetrics = null;
      }
    }
    ...
    public boolean equals(put_args that) {
      ...
      boolean this_present_newHMetrics = true && this.isSetNewHMetrics();
      boolean that_present_newHMetrics = true && that.isSetNewHMetrics();
      if (this_present_newHMetrics || that_present_newHMetrics) {
        if (!(this_present_newHMetrics && that_present_newHMetrics))
          return false;
        if (!this.newHMetrics.equals(that.newHMetrics))
          return false;
      }
    ...
    public int hashCode() {
      ...
      boolean present_newHMetrics = true && (isSetNewHMetrics());
      list.add(present_newHMetrics);
      if (present_newHMetrics)
        list.add(newHMetrics);
    ...
    public int compareTo(put_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetNewHMetrics()).compareTo(other.isSetNewHMetrics());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetNewHMetrics()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.newHMetrics, other.newHMetrics);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public String toString() {
      ...
      sb.append("newHMetrics:");
      if (this.newHMetrics == null) {
        sb.append("null");
      } else {
        sb.append(this.newHMetrics);
      }
      first = false;
      sb.append(")");
      return sb.toString();
    ...
    private static class put_argsStandardScheme extends StandardScheme<put_args> {
          ...
          switch (schemeField.id) {
            case 1: // NEW_HMETRICS
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.newHMetrics = new HMetrics();
                struct.newHMetrics.read(iprot);
                struct.setNewHMetricsIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, put_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.newHMetrics != null) {
          oprot.writeFieldBegin(NEW_HMETRICS_FIELD_DESC);
          struct.newHMetrics.write(oprot);
          oprot.writeFieldEnd();
        }
