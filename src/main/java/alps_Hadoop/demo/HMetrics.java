...
public class HMetrics implements org.apache.thrift.TBase<HMetrics, HMetrics._Fields>, java.io.Serializable, Cloneable, Comparable<HMetrics> {
  ...
  private static final org.apache.thrift.protocol.TField METRICS_FIELD_DESC = new org.apache.thrift.protocol.TField("metrics", org.apache.thrift.protocol.TType.MAP, (short)6);
  ...
  public HMetrics setTime(long time) {
    this.time = time;
    setTimeIsSet(true);
    return this;
  }
  ...
  public HMetrics setPrefix(String prefix) {
    this.prefix = prefix;
    return this;
  }
